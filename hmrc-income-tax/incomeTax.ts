...
export function calculateEnglishTaxes(
	taxRates: EnglishTaxRates, taxableAnnualIncome: number, personalAllowance: number
): EnglishIncomeTax {
  const {
...
export function calculateScottishTaxes(
	taxRates: ScottishTaxRates, taxableAnnualIncome: number, personalAllowance: number
): ScottishIncomeTax {
  const {
    DEFAULT_PERSONAL_ALLOWANCE,
    STARTER_RATE,
...
export function calculateIncomeTax(
	country: Country, taxableAnnualIncome: number, personalAllowance: number
): EnglishIncomeTax | ScottishIncomeTax {
  const taxRates = getHmrcRates(country);
